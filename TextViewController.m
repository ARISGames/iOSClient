...
//Do server call here
    ...
    [[[AppModel sharedAppModel] uploadManager]uploadContentForNoteId:self.noteId withTitle:nil withText:self.textBox.text withType:kNoteContentTypeText withFileURL:[NSString stringWithFormat:@"%@.txt",[NSDate date]]];
