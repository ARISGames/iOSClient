...
- (WebPageViewController *) viewControllerForDelegate:(NSObject<GameObjectViewControllerDelegate,StateControllerProtocol> *)d viewFrame:(CGRect)vf fromSource:(id)s
{
