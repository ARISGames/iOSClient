...
+ (UIColor*) ARISColorLighBlue  { return [UIColor colorWithRed:(132.0/255.0) green:(153.0/255.0)  blue:(165.0/255.0) alpha:1.0]; }
...
+ (UIColor*) ARISColorLightGrey { return [UIColor colorWithRed:(214.0/255.0) green:(218.0/255.0)  blue:(211.0/255.0) alpha:1.0]; }
